...
# %bb.0:                                # %entry
	...
	jmp	.LBB2_1
	.p2align	4, 0x90
.LBB2_8:                                # %entry.while.start.while.end
...
# %bb.4:                                # %entry.while.start.while.start
                                        #   in Loop: Header=BB2_3 Depth=2
	movl	-4040(%rbp,%rbx,4), %r12d
	leal	1(%rbx), %edi
	movl	$1000, %esi                     # imm = 0x3E8
	callq	__check_bounds__@PLT
	cmpl	-4036(%rbp,%rbx,4), %r12d
	jle	.LBB2_6
# %bb.5:                                # %entry.while.start.while.start.if
                                        #   in Loop: Header=BB2_3 Depth=2
	movq	%rsp, %r13
	leaq	-16(%r13), %rsp
	movl	-4040(%rbp,%rbx,4), %eax
	movl	%eax, -16(%r13)
	leal	1(%rbx), %r12d
	movl	%r12d, %edi
	movl	$1000, %esi                     # imm = 0x3E8
	callq	__check_bounds__@PLT
	movl	-4036(%rbp,%rbx,4), %eax
	movl	%eax, -4040(%rbp,%rbx,4)
	movl	%r12d, %edi
	movl	$1000, %esi                     # imm = 0x3E8
	callq	__check_bounds__@PLT
	movl	-16(%r13), %eax
	movl	%eax, -4036(%rbp,%rbx,4)
	jmp	.LBB2_6
