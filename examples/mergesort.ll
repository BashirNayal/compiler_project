...
entry.while.cond:                                 ; preds = %entry.while.start.while.end, %entry
  %curr_size.0 = phi i32 [ 1, %entry ], [ %1017, %entry.while.start.while.end ]
  %1001 = icmp sle i32 %curr_size.0, 999
  br i1 %1001, label %entry.while.start, label %entry.while.end

entry.while.start:                                ; preds = %entry.while.cond
  %cond2 = alloca i32, align 4
  store i32 999, i32* %cond2, align 4
  %1002 = load i32, i32* %cond2, align 4
  %1003 = sub i32 %curr_size.0, 1
  %1004 = sub i32 %curr_size.0, 1
  %1005 = mul i32 2, %curr_size.0
  %1006 = sub i32 %1005, 1
  %1007 = mul i32 2, %curr_size.0
  %1008 = sub i32 %1007, 1
  %1009 = mul i32 %curr_size.0, 2
  br label %entry.while.start.while.cond

entry.while.end:                                  ; preds = %entry.while.cond
  %end_time = alloca i32, align 4
  %1010 = call i32 @get_time()
  store i32 %1010, i32* %end_time, align 4
  %i2 = alloca i32, align 4
  store i32 0, i32* %i2, align 4
  %1011 = load i32, i32* %end_time, align 4
  %1012 = sub i32 %1011, %1000
  %1013 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @1, i32 0, i32 0), i32 %1012)
  ret i32 0

entry.while.start.while.cond:                     ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.end, %entry.while.start
  %left_start.0 = phi i32 [ 0, %entry.while.start ], [ %1096, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.end ]
  %1014 = icmp slt i32 %left_start.0, %1002
  br i1 %1014, label %entry.while.start.while.start, label %entry.while.start.while.end
...
entry.while.start.while.start:                    ; preds = %entry.while.start.while.cond
  ...
  store i32 0, i32* %right_end, align 4
  %1015 = add i32 %left_start.0, %1003
  %1016 = icmp sgt i32 %1015, 999
  br i1 %1016, label %entry.while.start.while.start.if, label %entry.while.start.while.start.else

entry.while.start.while.end:                      ; preds = %entry.while.start.while.cond
  %1017 = mul i32 %curr_size.0, 2
  br label %entry.while.cond

entry.while.start.while.start.if:                 ; preds = %entry.while.start.while.start
  store i32 999, i32* %mid, align 4
  br label %entry.while.start.while.start.endif

entry.while.start.while.start.else:               ; preds = %entry.while.start.while.start
  %1018 = add i32 %left_start.0, %1004
  store i32 %1018, i32* %mid, align 4
  br label %entry.while.start.while.start.endif

entry.while.start.while.start.endif:              ; preds = %entry.while.start.while.start.else, %entry.while.start.while.start.if
  %right_end1 = alloca i32, align 4
  store i32 0, i32* %right_end1, align 4
  %1019 = add i32 %left_start.0, %1006
  %1020 = icmp sgt i32 %1019, 999
  br i1 %1020, label %entry.while.start.while.start.endif.if, label %entry.while.start.while.start.endif.else

entry.while.start.while.start.endif.if:           ; preds = %entry.while.start.while.start.endif
  store i32 999, i32* %right_end1, align 4
  br label %entry.while.start.while.start.endif.endif

entry.while.start.while.start.endif.else:         ; preds = %entry.while.start.while.start.endif
  %1021 = add i32 %left_start.0, %1008
  store i32 %1021, i32* %right_end1, align 4
  br label %entry.while.start.while.start.endif.endif

entry.while.start.while.start.endif.endif:        ; preds = %entry.while.start.while.start.endif.else, %entry.while.start.while.start.endif.if
  %l = alloca i32, align 4
  store i32 %left_start.0, i32* %l, align 4
  %m = alloca i32, align 4
  %1022 = load i32, i32* %mid, align 4
  store i32 %1022, i32* %m, align 4
  %r = alloca i32, align 4
  %1023 = load i32, i32* %right_end1, align 4
  store i32 %1023, i32* %r, align 4
  ...
  %1027 = add i32 %1026, 1
  store i32 %1027, i32* %n1, align 4
  %n2 = alloca i32, align 4
  %1028 = load i32, i32* %r, align 4
  %1029 = load i32, i32* %m, align 4
  %1030 = sub i32 %1028, %1029
  store i32 %1030, i32* %n2, align 4
  %1031 = load i32, i32* %n1, align 4
  %L = alloca i32, i32 %1031, align 4
  %1032 = load i32, i32* %n2, align 4
  %R = alloca i32, i32 %1032, align 4
  %i1 = alloca i32, align 4
  store i32 0, i32* %i1, align 4
  %1033 = load i32, i32* %n1, align 4
  %1034 = load i32, i32* %l, align 4
  %i1.promoted = load i32, i32* %i1, align 4
  br label %entry.while.start.while.start.endif.endif.while.cond

entry.while.start.while.start.endif.endif.while.cond: ; preds = %entry.while.start.while.start.endif.endif.while.start, %entry.while.start.while.start.endif.endif
  %1035 = phi i32 [ %1041, %entry.while.start.while.start.endif.endif.while.start ], [ %i1.promoted, %entry.while.start.while.start.endif.endif ]
  %1036 = icmp slt i32 %1035, %1033
  br i1 %1036, label %entry.while.start.while.start.endif.endif.while.start, label %entry.while.start.while.start.endif.endif.while.end

entry.while.start.while.start.endif.endif.while.start: ; preds = %entry.while.start.while.start.endif.endif.while.cond
  call void @__check_bounds__(i32 %1035, i32 %1031)
  %1037 = getelementptr i32, i32* %L, i32 %1035
  %1038 = add i32 %1034, %1035
  call void @__check_bounds__(i32 %1038, i32 1000)
  %1039 = getelementptr i32, i32* %arr, i32 %1038
  %1040 = load i32, i32* %1039, align 4
  store i32 %1040, i32* %1037, align 4
  %1041 = add i32 %1035, 1
  br label %entry.while.start.while.start.endif.endif.while.cond

entry.while.start.while.start.endif.endif.while.end: ; preds = %entry.while.start.while.start.endif.endif.while.cond
  %.lcssa = phi i32 [ %1035, %entry.while.start.while.start.endif.endif.while.cond ]
  store i32 %.lcssa, i32* %i1, align 4
  %j1 = alloca i32, align 4
  store i32 0, i32* %j1, align 4
  %1042 = load i32, i32* %n2, align 4
  %1043 = load i32, i32* %m, align 4
  %1044 = add i32 %1043, 1
  %j1.promoted = load i32, i32* %j1, align 4
  br label %entry.while.start.while.start.endif.endif.while.end.while.cond

entry.while.start.while.start.endif.endif.while.end.while.cond: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.start, %entry.while.start.while.start.endif.endif.while.end
  %1045 = phi i32 [ %1051, %entry.while.start.while.start.endif.endif.while.end.while.start ], [ %j1.promoted, %entry.while.start.while.start.endif.endif.while.end ]
  %1046 = icmp slt i32 %1045, %1042
  br i1 %1046, label %entry.while.start.while.start.endif.endif.while.end.while.start, label %entry.while.start.while.start.endif.endif.while.end.while.end

entry.while.start.while.start.endif.endif.while.end.while.start: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.cond
  call void @__check_bounds__(i32 %1045, i32 %1032)
  %1047 = getelementptr i32, i32* %R, i32 %1045
  %1048 = add i32 %1044, %1045
  call void @__check_bounds__(i32 %1048, i32 1000)
  %1049 = getelementptr i32, i32* %arr, i32 %1048
  %1050 = load i32, i32* %1049, align 4
  store i32 %1050, i32* %1047, align 4
  %1051 = add i32 %1045, 1
  br label %entry.while.start.while.start.endif.endif.while.end.while.cond

entry.while.start.while.start.endif.endif.while.end.while.end: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.cond
  %.lcssa1 = phi i32 [ %1045, %entry.while.start.while.start.endif.endif.while.end.while.cond ]
  store i32 %.lcssa1, i32* %j1, align 4
  store i32 0, i32* %i, align 4
  store i32 0, i32* %j, align 4
  %1052 = load i32, i32* %l, align 4
  store i32 %1052, i32* %k, align 4
  %1053 = load i32, i32* %n1, align 4
  %1054 = load i32, i32* %n2, align 4
  %i.promoted = load i32, i32* %i, align 4
  %j.promoted = load i32, i32* %j, align 4
  %k.promoted = load i32, i32* %k, align 4
  br label %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond

entry.while.start.while.start.endif.endif.while.end.while.end.while.cond: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif, %entry.while.start.while.start.endif.endif.while.end.while.end
  %1055 = phi i32 [ %1077, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif ], [ %k.promoted, %entry.while.start.while.start.endif.endif.while.end.while.end ]
  %1056 = phi i32 [ %1075, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif ], [ %j.promoted, %entry.while.start.while.start.endif.endif.while.end.while.end ]
  %1057 = phi i32 [ %1076, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif ], [ %i.promoted, %entry.while.start.while.start.endif.endif.while.end.while.end ]
  %1058 = icmp slt i32 %1057, %1053
  %1059 = icmp slt i32 %1056, %1054
  %1060 = and i1 %1058, %1059
  br i1 %1060, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.start, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end

entry.while.start.while.start.endif.endif.while.end.while.end.while.start: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond
  call void @__check_bounds__(i32 %1057, i32 %1031)
  %1061 = getelementptr i32, i32* %L, i32 %1057
  %1062 = load i32, i32* %1061, align 4
  call void @__check_bounds__(i32 %1056, i32 %1032)
  %1063 = getelementptr i32, i32* %R, i32 %1056
  %1064 = load i32, i32* %1063, align 4
  %1065 = icmp sle i32 %1062, %1064
  br i1 %1065, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.if, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.else

entry.while.start.while.start.endif.endif.while.end.while.end.while.end: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond
  %.lcssa4 = phi i32 [ %1055, %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond ]
  %.lcssa3 = phi i32 [ %1056, %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond ]
  %.lcssa2 = phi i32 [ %1057, %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond ]
  store i32 %.lcssa2, i32* %i, align 4
  store i32 %.lcssa3, i32* %j, align 4
  store i32 %.lcssa4, i32* %k, align 4
  %1066 = load i32, i32* %n1, align 4
  %i.promoted5 = load i32, i32* %i, align 4
  %k.promoted7 = load i32, i32* %k, align 4
  br label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.cond

entry.while.start.while.start.endif.endif.while.end.while.end.while.start.if: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.start
  call void @__check_bounds__(i32 %1055, i32 1000)
  %1067 = getelementptr i32, i32* %arr, i32 %1055
  call void @__check_bounds__(i32 %1057, i32 %1031)
  %1068 = getelementptr i32, i32* %L, i32 %1057
  %1069 = load i32, i32* %1068, align 4
  store i32 %1069, i32* %1067, align 4
  %1070 = add i32 %1057, 1
  br label %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif

entry.while.start.while.start.endif.endif.while.end.while.end.while.start.else: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.start
  call void @__check_bounds__(i32 %1055, i32 1000)
  %1071 = getelementptr i32, i32* %arr, i32 %1055
  call void @__check_bounds__(i32 %1056, i32 %1032)
  %1072 = getelementptr i32, i32* %R, i32 %1056
  %1073 = load i32, i32* %1072, align 4
  store i32 %1073, i32* %1071, align 4
  %1074 = add i32 %1056, 1
  br label %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif

entry.while.start.while.start.endif.endif.while.end.while.end.while.start.endif: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.else, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.if
  %1075 = phi i32 [ %1074, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.else ], [ %1056, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.if ]
  %1076 = phi i32 [ %1057, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.else ], [ %1070, %entry.while.start.while.start.endif.endif.while.end.while.end.while.start.if ]
  %1077 = add i32 %1055, 1
  br label %entry.while.start.while.start.endif.endif.while.end.while.end.while.cond

entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.cond: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.start, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end
  %1078 = phi i32 [ %1085, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.start ], [ %k.promoted7, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end ]
  %1079 = phi i32 [ %1084, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.start ], [ %i.promoted5, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end ]
  %1080 = icmp slt i32 %1079, %1066
  br i1 %1080, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.start, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end

entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.start: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.cond
  call void @__check_bounds__(i32 %1078, i32 1000)
  %1081 = getelementptr i32, i32* %arr, i32 %1078
  call void @__check_bounds__(i32 %1079, i32 %1031)
  %1082 = getelementptr i32, i32* %L, i32 %1079
...
entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.cond
  %.lcssa8 = phi i32 [ %1078, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.cond ]
  %.lcssa6 = phi i32 [ %1079, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.cond ]
  store i32 %.lcssa6, i32* %i, align 4
  store i32 %.lcssa8, i32* %k, align 4
  %1086 = load i32, i32* %n2, align 4
  %j.promoted9 = load i32, i32* %j, align 4
  %k.promoted11 = load i32, i32* %k, align 4
  br label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.cond

entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.cond: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.start, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end
  %1087 = phi i32 [ %1094, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.start ], [ %k.promoted11, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end ]
  %1088 = phi i32 [ %1093, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.start ], [ %j.promoted9, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end ]
  %1089 = icmp slt i32 %1088, %1086
  br i1 %1089, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.start, label %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.end

entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.start: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.cond
  call void @__check_bounds__(i32 %1087, i32 1000)
  %1090 = getelementptr i32, i32* %arr, i32 %1087
  call void @__check_bounds__(i32 %1088, i32 %1032)
  %1091 = getelementptr i32, i32* %R, i32 %1088
...
entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.end: ; preds = %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.cond
  %.lcssa12 = phi i32 [ %1087, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.cond ]
  %.lcssa10 = phi i32 [ %1088, %entry.while.start.while.start.endif.endif.while.end.while.end.while.end.while.end.while.cond ]
  store i32 %.lcssa10, i32* %j, align 4
  store i32 %.lcssa12, i32* %k, align 4
  %temp_1 = alloca i32, align 4
  store i32 %1009, i32* %temp_1, align 4
  %1095 = load i32, i32* %temp_1, align 4
  %1096 = add i32 %left_start.0, %1095
  br label %entry.while.start.while.cond
}
