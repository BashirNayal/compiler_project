...
entry.while.cond:                                 ; preds = %entry.while.start.while.end, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %1022, %entry.while.start.while.end ]
  %cmp = icmp slt i32 %i.0, 1000
  br i1 %cmp, label %entry.while.start, label %entry.while.end

entry.while.start:                                ; preds = %entry.while.cond
  %value = alloca i32, align 4
  %1001 = getelementptr i32, i32* %arr, i32 %i.0
  %1002 = load i32, i32* %1001, align 4
  store i32 %1002, i32* %value, align 4
  %j = alloca i32, align 4
  store i32 %i.0, i32* %j, align 4
  %1003 = load i32, i32* %value, align 4
...
entry.while.end:                                  ; preds = %entry.while.cond
  ...
  %1004 = call i32 @get_time()
  store i32 %1004, i32* %end_time, align 4
  %i1 = alloca i32, align 4
  store i32 0, i32* %i1, align 4
  %1005 = load i32, i32* %end_time, align 4
  %1006 = sub i32 %1005, %1000
  %1007 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @1, i32 0, i32 0), i32 %1006)
  ret i32 0

entry.while.start.while.cond:                     ; preds = %entry.while.start.while.start, %entry.while.start
  %1008 = phi i32 [ %1018, %entry.while.start.while.start ], [ %j.promoted, %entry.while.start ]
  %cmp1 = icmp sgt i32 %1008, 0
  %1009 = sub i32 %1008, 1
  call void @__check_bounds__(i32 %1009, i32 1000)
  %1010 = getelementptr i32, i32* %arr, i32 %1009
  %1011 = load i32, i32* %1010, align 4
  %1012 = icmp sgt i32 %1011, %1003
  %1013 = and i1 %cmp1, %1012
  br i1 %1013, label %entry.while.start.while.start, label %entry.while.start.while.end

entry.while.start.while.start:                    ; preds = %entry.while.start.while.cond
  call void @__check_bounds__(i32 %1008, i32 1000)
  %1014 = getelementptr i32, i32* %arr, i32 %1008
  %1015 = sub i32 %1008, 1
  call void @__check_bounds__(i32 %1015, i32 1000)
  %1016 = getelementptr i32, i32* %arr, i32 %1015
...
entry.while.start.while.end:                      ; preds = %entry.while.start.while.cond
  %.lcssa = phi i32 [ %1008, %entry.while.start.while.cond ]
  store i32 %.lcssa, i32* %j, align 4
  %1019 = load i32, i32* %j, align 4
  call void @__check_bounds__(i32 %1019, i32 1000)
  %1020 = getelementptr i32, i32* %arr, i32 %1019
  %1021 = load i32, i32* %value, align 4
  store i32 %1021, i32* %1020, align 4
  %1022 = add i32 %i.0, 1
  br label %entry.while.cond
}
