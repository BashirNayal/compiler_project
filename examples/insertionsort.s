...
# %bb.0:                                # %entry
	...
	jmp	.LBB2_1
	.p2align	4, 0x90
.LBB2_6:                                # %entry.while.start.while.end
...
# %bb.2:                                # %entry.while.start
	...
	movq	%rcx, %rsp
	movslq	%ebx, %rcx
	leaq	-4064(%rbp,%rcx,4), %r14
	movl	-4064(%rbp,%rcx,4), %ecx
	movl	%ecx, -16(%rax)
	movq	%rsp, %rcx
	leaq	-16(%rcx), %rdx
...
.LBB2_3:                                # %entry.while.start.while.cond
	...
	testl	%r15d, %r15d
	jle	.LBB2_6
# %bb.4:                                # %entry.while.start.while.cond
                                        #   in Loop: Header=BB2_3 Depth=2
	movslq	%ebx, %r12
	cmpl	%r13d, -4064(%rbp,%r12,4)
	jle	.LBB2_6
# %bb.5:                                # %entry.while.start.while.start
                                        #   in Loop: Header=BB2_3 Depth=2
	movl	%r15d, %edi
	movl	$1000, %esi                     # imm = 0x3E8
	callq	__check_bounds__@PLT
	...
	movl	$1000, %esi                     # imm = 0x3E8
	callq	__check_bounds__@PLT
	movl	-4064(%rbp,%r12,4), %eax
	movl	%eax, (%r14)
	addq	$-4, %r14
	jmp	.LBB2_3
.LBB2_7:                                # %entry.while.end
	movq	%rsp, %rbx
	leaq	-16(%rbx), %rsp
	callq	get_time@PLT
	movl	%eax, -16(%rbx)
