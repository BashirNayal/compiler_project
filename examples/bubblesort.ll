...
entry.while.cond:                                 ; preds = %entry.while.start.while.end, %entry
  %j.0 = phi i32 [ 0, %entry ], [ %1012, %entry.while.start.while.end ]
  %1001 = icmp slt i32 %j.0, 999
...
entry.while.start.while.cond:                     ; preds = %entry.while.start.while.start.endif, %entry.while.start
  %i.0 = phi i32 [ 0, %entry.while.start ], [ %1022, %entry.while.start.while.start.endif ]
...
entry.while.start.while.start:                    ; preds = %entry.while.start.while.cond
  %1006 = getelementptr i32, i32* %arr, i32 %i.0
  %1007 = load i32, i32* %1006, align 4
  %1008 = add i32 %i.0, 1
  call void @__check_bounds__(i32 %1008, i32 1000)
  %1009 = getelementptr i32, i32* %arr, i32 %1008
  %1010 = load i32, i32* %1009, align 4
  %1011 = icmp sgt i32 %1007, %1010
  br i1 %1011, label %entry.while.start.while.start.if, label %entry.while.start.while.start.endif
...
entry.while.start.while.start.if:                 ; preds = %entry.while.start.while.start
  ...
  %1013 = getelementptr i32, i32* %arr, i32 %i.0
  %1014 = load i32, i32* %1013, align 4
  store i32 %1014, i32* %temp, align 4
  %1015 = getelementptr i32, i32* %arr, i32 %i.0
  %1016 = add i32 %i.0, 1
  call void @__check_bounds__(i32 %1016, i32 1000)
  %1017 = getelementptr i32, i32* %arr, i32 %1016
  %1018 = load i32, i32* %1017, align 4
  store i32 %1018, i32* %1015, align 4
  %1019 = add i32 %i.0, 1
  call void @__check_bounds__(i32 %1019, i32 1000)
  %1020 = getelementptr i32, i32* %arr, i32 %1019
  %1021 = load i32, i32* %temp, align 4
